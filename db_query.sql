...
insert into kursi (emri_kursit, create_date, update_date, kohezgjatja) values ('JavaScript','12/06/2023','15/06/2023',2);

insert into kursi (emri_kursit, create_date, update_date, kohezgjatja) values ('C++','20/11/2023','25/11/2023',5);

insert into kursi (emri_kursit, create_date, update_date, kohezgjatja) values ('React','05/03/2024','10/03/2024',3);

insert into kursi (emri_kursit, create_date, update_date, kohezgjatja) values ('Angular','18/07/2024','20/07/2024',4);
